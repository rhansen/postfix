...
/*	runs.  TEST_CASE.action returns PASS or FAIL.
/*
...
/*	test cases.  The final test case to run must be followed by a
/*	zero TEST_CASE (label and action are null).  The start and end
/*	of each test case is logged, and a summary of the results is
/*	logged at the end.
/* LICENSE
/* .ad
/* .fi
...
int     run_tests(const struct TEST_CASE *test_cases)
{
    int tests_passed = 0;
    int tests_failed = 0;
